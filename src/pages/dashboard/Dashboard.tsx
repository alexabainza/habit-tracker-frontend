      ...
      <div className="w-full bg-gradient-to-br from-[#2A3D43] to-[#40575C] flex flex-col py-8 lg:px-16 sm:px-8 px-5">
        ...
        <div className="m-auto space-y-8">
          ...
          <Button
            asChild
            size="lg"
            className="w-full font-bold text-xl bg-lightYellow text-black hover:bg-yellow-400 transition-all duration-300 hover:-translate-y-0.5 shadow-sm shadow-black hover:shadow hover:shadow-black"
          >
            <Link
              to="/habits/?create=true"
              className="w-40 h-14 flex items-center gap-x-2"
            >
        ...
        <section className="w-full flex flex-col pt-8 space-y-4 md:flex-row items-end justify-between">
          ...
          {totalPages > 1 && (
            <Pagination
              ...
              setPage={setPage}
              className="w-full flex justify-start md:justify-end items-center md:gap-4 mt-4 text-lightYellow"
            />
          )}
        </section>
